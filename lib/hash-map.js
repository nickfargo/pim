...
(function() {
  var Collision, HashMap, Iterator, Node, PairwiseArrayIterator, base32, base32p, bin32p, format, formatWithHashes, formatWithHashesInBase32, hashOf, hex32p, populationOf, print, typeOf, uid, valueOf, _ref;
  ...
  module.exports = HashMap = (function() {
    ...
    accrete = function(source, iterable, target) {
      ...
      iterator = (typeof iterable === "function" ? iterable() : void 0) || (typeof iterable.__iterator__ === "function" ? iterable.__iterator__() : void 0) || (typeof iterable.next === 'function' ? iterable : void 0) || new PairwiseArrayIterator(iterable);
      while (true) {
    ...
    HashMap.prototype.print = (function() {
      ...
      printPair = function(key, value) {
        return "Pair (#" + (base32p(key.__hash__)) + ") <" + (valueOf(key)) + ", " + (valueOf(value)) + ">\n";
      };
      return function() {
